...
For these exercises, we'll plot one last dataset: the [Datasaurus](https://www.autodesk.com/research/publications/same-stats-different-graphs){target="_blank"} dataset. The Datasaurus dataset features a series of points that all have the same descriptive statistics (mean, standard deviation, etc.) but have very different distributions that are apparent upon visualization. The namesake distribution is... a T-rex!
