...
These next exercises demonstrate features you might use when plotting discrete data with many levels.
...
This section will demonstrate changing some theme elements, but is not an exhaustive example of every modifiable theme element. For that, refer to [section 18.4](https://ggplot2-book.org/polishing.html#theme-elements) of the textbook.
...
Again, change all the text to Comic Sans MS font, _and_ change the plot's subtitle to appear in bold font face.
